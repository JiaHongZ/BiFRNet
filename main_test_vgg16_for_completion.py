...
if __name__ == '__main__':
    ...
    # Test parameters #
    ###################
    # occ_levels = ['ZERO']  # occlusion levels to be evaluated [0%,20-40%,40-60%,60-80%]
    occ_levels = ['ZERO', 'ONE', 'FIVE', 'NINE']  # occlusion levels to be evaluated [0%,20-40%,40-60%,60-80%]
    # occ_levels = ['NINE']  # occlusion levels to be evaluated [0%,20-40%,40-60%,60-80%]
    ...
    data_path = r'E:\image_denoising\datasets\data_compnet\\'
    ...
    for occ_level in occ_levels:
        ...
        for index, occ_type in enumerate(occ_types):
            ...
            acc = test(mynet, test_data=test_imgset, batch_size=batch_size_test)
